#define NGX_CONFIGURE " --prefix=/etc/nginx --sbin-path=/usr/sbin/nginx --modules-path=/usr/lib/nginx/modules --conf-path=/etc/nginx/nginx.conf --error-log-path=/var/log/nginx/error.log --http-log-path=/var/log/nginx/access.log --pid-path=/var/run/nginx.pid --lock-path=/var/run/nginx.lock --http-client-body-temp-path=/var/cache/nginx/client_temp --http-proxy-temp-path=/var/cache/nginx/proxy_temp --http-fastcgi-temp-path=/var/cache/nginx/fastcgi_temp --http-uwsgi-temp-path=/var/cache/nginx/uwsgi_temp --http-scgi-temp-path=/var/cache/nginx/scgi_temp --user=nginx --group=nginx --with-compat --with-file-aio --with-threads --with-http_addition_module --with-http_auth_request_module --with-http_dav_module --with-http_flv_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_mp4_module --with-http_random_index_module --with-http_realip_module --with-http_secure_link_module --with-http_slice_module --with-http_ssl_module --with-http_stub_status_module --with-http_sub_module --with-http_v2_module --with-mail --with-mail_ssl_module --with-stream --with-stream_realip_module --with-stream_ssl_module --with-stream_ssl_preread_module --with-debug --with-http_v3_module --with-http_quic_module --with-stream_quic_module --add-module=/usr/src/nginx-1.19.6/debian/modules/ngx_pagespeed --add-module=/usr/src/nginx-1.19.6/debian/modules/ngx_brotli --add-module=/usr/src/ModSecurity/nginx/modsecurity --with-cc-opt='-I/usr/src/boringssl/include -g -O2 -fdebug-prefix-map=/usr/src/nginx-1.19.6=. -fstack-protector-strong -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fPIC' --with-ld-opt='-L/usr/src/boringssl/build/ssl -L/usr/src/boringssl/build/crypto -Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,now -Wl,--as-needed -pie'"
...
#ifndef NGX_STREAM_QUIC
#define NGX_STREAM_QUIC  1
#endif
...
#ifndef NGX_OPENSSL_QUIC
#define NGX_OPENSSL_QUIC  1
#endif
...
#ifndef NGX_OPENSSL_QUIC_ZRTT_CTX
#define NGX_OPENSSL_QUIC_ZRTT_CTX  1
#endif
